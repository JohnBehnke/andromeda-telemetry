...
define(
    ['./AndromedaTelemetrySeries'],
    function(AndromedaTelemetrySeries) {
        "use strict";

        var SOURCE = "andromeda.source";

        function AndromedaTelemetryProvider(adapter, $q) {
            var subscribers = {};
            ...
            adapter.listen(function(message) {
                ...
                packaged[SOURCE][message.id] =
                    new AndromedaTelemetrySeries([message.value]);
                ...
                requestTelemetry: function(requests) {
                    ...
                    function addToPackage(history) {
                        packaged[SOURCE][history.id] =
                            new AndromedaTelemetrySeries(history.value);
                    }
        ...
        return AndromedaTelemetryProvider;
    }
);